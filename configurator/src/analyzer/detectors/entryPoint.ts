 ...
 */
export async function detectEntryPoint(projectPath: string): Promise<EntryPointResult> {
 ...
 */
export async function detectAppFile(projectPath: string): Promise<string | null> {
  const patterns = [
    'src/App.tsx',
    'src/App.ts',
    'src/App.jsx',
 ...
 */
export async function detectGlobalCssFile(projectPath: string): Promise<string | null> {
  const patterns = [
    'src/index.css',
    'src/global.css',
    'src/globals.css',
