 ...
 */
export async function detectBuildTool(projectPath: string): Promise<BuildToolResult> {
 ...
 */
export async function detectPostCssConfig(projectPath: string): Promise<string | null> {
  const configs = [
    'postcss.config.js',
    'postcss.config.cjs',
    'postcss.config.mjs',
